...
# If no results found, consider increasing detection mode to `aggressive`
...
Usage: wpscan [options]
    ...
    -f, --format FORMAT                           Output results in the format supplied
        ...
        --user-agents-list FILE-PATH              List of agents to use with --random-user-agent
                                                  Default: /var/lib/gems/3.1.0/gems/cms_scanner-0.15.0/app/user_agents.txt
